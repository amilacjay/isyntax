...
from wordquery.xml_creater import *
...
class App:
    ...
    def run(self):
        ...
        # xmlcreater = Fetcher("root", "", "comapany_new")
        # xml_file = xmlcreater.createXml()
        ...
        if value:
            symbol, prv_attribute, list_of_nouns, operator, condition_att_list = find_condition_elements(
                tokens_of_remaining,
                att, noun_list,
                userInput, xml_file)
        else:
            ...
            if t[0][0] == identified_table[0]:
                ...
                if condition_att_list == '' or condition_att_list[0][0] in at_set:
                    ...
                    try:
                        ...
                        sql = create_twoTable_query(ref_tables[0], identified_table[0], list_ref, identified_attribute,
                                                    value,
                                                    prv_attribute)
...
if __name__ == "__main__":
    userinput = "what is the name of employee whose wage equals '30000' and departmentnumber equals '5' "
